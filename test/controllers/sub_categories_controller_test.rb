...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { id_categoria: @sub_category.id_categoria, nome_subcategoria: @sub_category.nome_subcategoria }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { id_categoria: @sub_category.id_categoria, nome_subcategoria: @sub_category.nome_subcategoria }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
